...
export const QUEUE_DRAIN_METADATA_KEY = "__queueDrain";
export const DEFAULT_RUNTIME_TIMEOUT_MS = 120_000;
export const DEFAULT_RUNTIME_PROMPT_TIMEOUT_MS = 300_000;
export const STREAMED_METADATA_CACHE_LIMIT = 10_000;
export const STREAMDOWN_RENDER_DEBOUNCE_MS = 100;
export const STREAMDOWN_LIVE_HIGHLIGHT_DEBOUNCE_MS = 16;
