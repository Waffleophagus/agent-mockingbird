...
export function RightFlyout(props: RightFlyoutProps) {
  ...
  return (
    <aside className="oc-session-flyout">
      <div className="oc-sidepanel-header">
        <div>
          <p className="oc-sidepanel-kicker">Inspector</p>
          <h3 className="oc-sidepanel-title">{activeSession?.title ?? "Main"}</h3>
        </div>
        <Button type="button" size="sm" variant="outline" className="oc-panel-close" onClick={onClose}>
